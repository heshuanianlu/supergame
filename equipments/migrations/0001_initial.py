    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=60, unique=True, verbose_name='装备名称')),
                ('cover', models.ImageField(default='none.png', upload_to='equipment/img/', verbose_name='装备图标')),
                ('action', models.ImageField(default='none.png', upload_to='equipment/act_gif/', verbose_name='装备动作')),
